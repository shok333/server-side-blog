            ...
            <Form onSubmit={this.submitHandler} className="login-form">
                <FormItem>
                    {getFieldDecorator('email', {
                        ...
                        <Input onChange={this.emailValueHandler} prefix={<Icon type="email" style={{ color: 'rgba(0,0,0,.25)' }} />} placeholder="email" />
                    )}
                </FormItem>
                <FormItem>
...
function mapDispatchToProps(dispatch) {
    return {
        registrationRequest: bindActionCreators(registrationAction, dispatch),
    }
}

export default connect(null, mapDispatchToProps)(Form.create()(Registration));